...
func TestParse(t *testing.T) {
	...
	t.Setenv("MARKETPLACE_0_URL", "test")
	t.Setenv("MARKETPLACE_0_URL_ADDITIONAL", "test")
	t.Setenv("MARKETPLACE_0_TOKEN", "test")

	t.Setenv("MARKETPLACE_1_NAME", "test1")
	t.Setenv("MARKETPLACE_1_ID", "test1")
	t.Setenv("MARKETPLACE_1_URL_ADDITIONAL", "test1")
	t.Setenv("MARKETPLACE_1_URL", "test1")
	t.Setenv("MARKETPLACE_1_TOKEN", "test1")

	t.Setenv("MARKETPLACE_2_NAME", "test2")
	t.Setenv("MARKETPLACE_2_ID", "test2")
	t.Setenv("MARKETPLACE_2_URL", "test2")
	t.Setenv("MARKETPLACE_2_URL_ADDITIONAL", "test2")
